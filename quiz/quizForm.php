	...
	<form action="quizSubmit.php?id=<?php echo $id; ?>" method="post">
		...
		<div class="quizzes">
			...
			<input type='hidden' value='0' name="quiz[]">
				<button class="add_quiz_button">Add More Quizzes</button>
				<div class="input_fields_wrap">
					<button class="add_question">Add More Questions</button>
					<!--<button class="add_answer">Add More answers</button> -->
					<div class="question" id = "1">
						<button class="add_answer">Add More answers</button>
						</br>
						<input type="text" name="mytext_question1[]">
						
						<div class="answer">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<input type='hidden' value='0' name="correct_answer1,1[]"><input type="checkbox" name="correct_answer1,1[]" value="1"><input type="text" name="mytext_answer1,1[]">
						</div>
		...
		$(document).ready(function() {
		    ...
		    $(document).on('click','.add_question',function(e){
		       ...
		       { 
		            ...
		            $(this).parent('div.input_fields_wrap').append('<div class="question" id = '+ x + '><button class="add_answer">Add More answers</button></br><input type="text" name="mytext_question' + quiz_number + '[]"/><a href="#" class="remove_question">Remove</a><div class="answer">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<input type="hidden" name="correct_answer'+x+ ',' + quiz_number + '[]" value="0"><input type="checkbox" name="correct_answer'+x+ ',' + quiz_number + '[]" value="1"><input type="text" name="mytext_answer'+ x + ',' + quiz_number + '[]"></div></div>'); //add input box
		       }
		    });
			...
			$(document).on('click','.add_answer',function(e){
				...
				// alert(y);
				$(this).parent('div').append('<div class="answer"> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<input type="hidden" name="correct_answer'+y+ ',' + q + '[]" value="0"><input type="checkbox" name="correct_answer'+ y + ',' + q +  '[]" value="1"><input type="text" name="mytext_answer'+ y + ',' + q +  '[]"> <a href="#" class="remove_field">Remove</a></div>'); //add input box
			...
			$(document).on('click','.add_quiz_button',function(e){
				...
				$(this).closest('div.quizzes').append('<div class="quiz" id ="' + quiz_count + '"> <input type="hidden" value="0" name="quiz[]"><a href="#" class="remove_quiz">Remove Quiz</a> <div class="input_fields_wrap"><button class="add_question">Add More Questions</button><div class="question" id = "1"><button class="add_answer">Add More answers</button></br><input type="text" name="mytext_question' + quiz_count + '[]"><div class="answer">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<input type="hidden" value="0" name="correct_answer1' + ','  + quiz_count + '[]"><input type="checkbox" name="correct_answer1' + ','  + quiz_count + '[]" value="1"><input type="text" name="mytext_answer1' + ',' +  quiz_count + '[]"></div></div></div></div>');
				question_counter.push(1);
			});

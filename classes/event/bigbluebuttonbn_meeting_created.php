...
class bigbluebuttonbn_meeting_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_meeting_created', 'mod_streamline');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created a streamline meeting for the streamline activity with id '$this->contextinstanceid' for " .

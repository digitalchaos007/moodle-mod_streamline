...
class bigbluebuttonbn_activity_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_activity_viewed', 'mod_streamline');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the streamline activity with id '$this->contextinstanceid' for " .
